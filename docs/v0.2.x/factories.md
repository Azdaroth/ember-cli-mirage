...
When building objects using factories, you may want to create related objects automatically. To build related objects, you can use either `association` helper.
